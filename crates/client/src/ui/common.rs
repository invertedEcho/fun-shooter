...
pub const TITLE_FONT_SIZE: FontSize = FontSize::Px(64.0);
pub const DEFAULT_FONT_SIZE: FontSize = FontSize::Px(32.0);
pub const SMALL_FONT_SIZE: FontSize = FontSize::Px(16.0);
